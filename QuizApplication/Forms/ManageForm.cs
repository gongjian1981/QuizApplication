...
namespace QuizApplication.Forms
{
    public partial class ManageForm : Form
    {
        ...
        private TableLayoutPanel BuildQuestionTable()
        {
            ...
            // Populate the table with questions data
            for (int i = 0; i < questions.Count; i++)
            {
                ...
                var btnDelete = new Button
                {
                    ...
                    Size = new Size(80, 30),
                    Tag = question,  // Store the question in the button's Tag for later use
                };
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                RefreshTable(); // Reload table after adding
            }
        }
        ...
        // Handle Delete button click for each question
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (question != null)
            {
                var result = MessageBox.Show($"Are you sure you want to delete the question: {question.QuestionText}?", "Confirm Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                if (result == DialogResult.Yes)
                {
                    DbUtil.DeleteQuestion(question);  // Delete from DB
                    RefreshTable();
                }
            }
        }
